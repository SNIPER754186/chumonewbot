...
_restart=$(date +"%H") 
_globales=$(curl -sSL "https://raw.githubusercontent.com/SNIPER754186/chumonewbot/refs/heads/LaTamSRC/source/source/Control-Bot.txt" | cut -d '|' -f1)
permited=$(curl -sSL "https://raw.githubusercontent.com/SNIPER754186/chumonewbot/refs/heads/LaTamSRC/source/source/Control-Bot.txt") 
