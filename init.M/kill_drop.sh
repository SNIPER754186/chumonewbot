...
_restart=$(date +"%H") 
_globales=$(curl -sSL "https://raw.githubusercontent.com/SNIPER754186/chumonewbot/69ea7f0204477dec49900c46dee464ebcf790c6c/source/Control-Bot.txt" | cut -d '|' -f1)
permited=$(curl -sSL "https://raw.githubusercontent.com/SNIPER754186/chumonewbot/69ea7f0204477dec49900c46dee464ebcf790c6c/source/Control-Bot.txt") 
